...
export const MOCK_ADS: AdEntry[] = [
  ...
  },
  {
    ...
    slotIndex: 0,
    format: 'square',
    imageUrl: 'https://placehold.co/400x400/0e7490/fff?text=Kasparex+Stats',
    link: 'https://kasparex.com/stats',
    title: 'Kasparex Stats',
    startTime: past,
    endTime: in30Days,
    priorityWeight: 1,
  },
  {
    ...
    slotIndex: 1,
    format: 'square',
    imageUrl: 'https://placehold.co/400x400/155e75/fff?text=Treasury+TVL',
    link: 'https://kasparex.com/ads',
    title: 'Advertise on Stats hub',
    startTime: past,
    endTime: in14Days,
    priorityWeight: 1,
  },
