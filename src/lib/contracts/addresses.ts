...
const HARDCODED_FALLBACK_ADDRESSES = {
  ...
  igraGalleonTestnet: {
    ...
    QuizToEarn: "",
    GRIDToken: "",
    tGRID: "0x3F19cC54231fB10b1935FA3f04Bec64b8AFeAd85",
    RewardVault: "",
    RewardManager: "0xD3D759E7d7d0F68C704D973247e254157FEDD825",
    ProofOfUtility: "0x689Fcc5b3A665745Eb9B1ac03A8A40e9DB2D9e38",
    SecureProofOfUtility: "",
    FeeHandler: "",
    AffiliateManager: "",
    LoyaltyPoints: "0x1cF432A52A0f2D09c8E7450CC40E4FC1422E8936",
    ProfileRegistry: "",
    UserProfileDashboard: "",
    AdminDashboard: "",
    PromoMintRouter: "",
    RevenueTreeManager: "0x56a64016D5A852B3CBeDC10c5FfF3A7D69B4B272",
...
export const CONTRACT_ADDRESSES = {
  ...
  igraGalleonTestnet: {
    ...
    tGRID: getEnvVar('NEXT_PUBLIC_TGRID_ADDRESS_IGRA_GALLEON_TESTNET') || getEnvVar('NEXT_PUBLIC_TGRID_ADDRESS_38836') || DEFAULT_CONTRACT_ADDRESSES.igraGalleonTestnet.tGRID,
  ...
  igraMainnet: {
    ...
    QuizToEarn: getEnvVar('NEXT_PUBLIC_QUIZ_TO_EARN_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.QuizToEarn || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.QuizToEarn,
    GRIDToken: getEnvVar('NEXT_PUBLIC_GRID_TOKEN_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.GRIDToken || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.GRIDToken,
    tGRID: getEnvVar('NEXT_PUBLIC_TGRID_ADDRESS_IGRA_MAINNET') || getEnvVar('NEXT_PUBLIC_TGRID_ADDRESS_38833') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.tGRID,
    RewardVault: getEnvVar('NEXT_PUBLIC_REWARD_VAULT_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.RewardVault || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.RewardVault,
    RewardManager: getEnvVar('NEXT_PUBLIC_REWARD_MANAGER_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.RewardManager || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.RewardManager,
    ProofOfUtility: getEnvVar('NEXT_PUBLIC_PROOF_OF_UTILITY_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.ProofOfUtility || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.ProofOfUtility,
    SecureProofOfUtility: getEnvVar('NEXT_PUBLIC_SECURE_PROOF_OF_UTILITY_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.SecureProofOfUtility || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.SecureProofOfUtility,
    FeeHandler: getEnvVar('NEXT_PUBLIC_FEE_HANDLER_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.FeeHandler || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.FeeHandler,
    AffiliateManager: getEnvVar('NEXT_PUBLIC_AFFILIATE_MANAGER_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.AffiliateManager || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.AffiliateManager,
    LoyaltyPoints: getEnvVar('NEXT_PUBLIC_LOYALTY_POINTS_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.LoyaltyPoints || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.LoyaltyPoints,
    ProfileRegistry: getEnvVar('NEXT_PUBLIC_PROFILE_REGISTRY_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.ProfileRegistry || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.ProfileRegistry,
    UserProfileDashboard: getEnvVar('NEXT_PUBLIC_USER_PROFILE_DASHBOARD_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.UserProfileDashboard || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.UserProfileDashboard,
    AdminDashboard: getEnvVar('NEXT_PUBLIC_ADMIN_DASHBOARD_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.AdminDashboard || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.AdminDashboard,
    PromoMintRouter: getEnvVar('NEXT_PUBLIC_PROMO_MINT_ROUTER_ADDRESS_IGRA_MAINNET') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.PromoMintRouter,
    RevenueTreeManager: getEnvVar('NEXT_PUBLIC_REVENUE_TREE_MANAGER_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.RevenueTreeManager || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.RevenueTreeManager,
    FeeRouter: getEnvVar('NEXT_PUBLIC_FEE_ROUTER_ADDRESS_IGRA_MAINNET') || HARDCODED_FALLBACK_ADDRESSES.igraMainnet.FeeRouter || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.FeeRouter,
    GenesisBadge: getEnvVar('NEXT_PUBLIC_GENESIS_BADGE_ADDRESS_IGRA_MAINNET') || getEnvVar('NEXT_PUBLIC_GENESIS_BADGE_ADDRESS_38833') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.GenesisBadge,
    DonationEscrow:
      getEnvVar('NEXT_PUBLIC_DONATION_ESCROW_ADDRESS_IGRA_MAINNET') ||
