...
export const CONTRACT_ADDRESSES = {
  ...
  igraMainnet: {
    ...
    RevenueTreeManager: getEnvVar('NEXT_PUBLIC_REVENUE_TREE_MANAGER_ADDRESS_IGRA_MAINNET') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.RevenueTreeManager,
    FeeRouter: getEnvVar('NEXT_PUBLIC_FEE_ROUTER_ADDRESS_IGRA_MAINNET') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.FeeRouter,
    ...
    DonationEscrow: getEnvVar('NEXT_PUBLIC_DONATION_ESCROW_ADDRESS_IGRA_MAINNET') || getEnvVar('NEXT_PUBLIC_DONATION_ESCROW_ADDRESS_38833') || DEFAULT_CONTRACT_ADDRESSES.igraMainnet.DonationEscrow,
  },
};
