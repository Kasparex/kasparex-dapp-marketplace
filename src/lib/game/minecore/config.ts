...
export const MINECORE_MACHINES: Record<MinecoreMachineId, MachineConfig> = {
  'pulse-drill': { id: 'pulse-drill', label: 'Pulse Drill', durationMs: 10 * 60_000, baseOutput: 50 },
  'crystal-extractor': { id: 'crystal-extractor', label: 'Crystal Extractor', durationMs: 30 * 60_000, baseOutput: 180 },
  'deep-vein-rig': { id: 'deep-vein-rig', label: 'Deep Vein Rig', durationMs: 60 * 60_000, baseOutput: 420 },
  'quantum-fracturer': { id: 'quantum-fracturer', label: 'Quantum Fracturer', durationMs: 6 * 60 * 60_000, baseOutput: 3200 },
};
...
export const MINECORE_BATTERIES: Record<MinecoreBatteryId, BatteryConfig> = {
  'energy-cell': { id: 'energy-cell', label: 'Energy Cell', efficiency: 1.0, powerCapacity: 1 },
  'battery-pack': { id: 'battery-pack', label: 'Battery Pack', efficiency: 1.15, powerCapacity: 2 },
  'diamond-capacitor': { id: 'diamond-capacitor', label: 'Diamond Capacitor', efficiency: 1.3, powerCapacity: 3 },
  'grid-battery': { id: 'grid-battery', label: 'Grid Battery', efficiency: 1.5, powerCapacity: 4 },
};
...
export const MINECORE_RECIPES: Recipe[] = [
  {
    ...
    title: 'Pulse Drill',
    kind: 'machine',
    outputId: 'pulse-drill',
    requires: { alloyPlates: 10, circuitMesh: 5, energyCells: 2 },
  },
  {
  ...
  },
  {
    ...
    requires: { alloyPlates: 35, circuitMesh: 16, coreShards: 3, energyCells: 6 },
  },
  {
    id: 'energy-cell',
    title: 'Energy Cell',
    ...
    requires: { circuitMesh: 2, energyCells: 1 },
  },
  {
    id: 'cooling-module',
    title: 'Cooling Module',
    kind: 'module',
    outputId: 'cooling-module',
    requires: { coolingGel: 6, alloyPlates: 4 },
  },
  {
    id: 'stability-module',
    title: 'Stability Module',
    kind: 'module',
    outputId: 'stability-module',
    requires: { alloyPlates: 6, circuitMesh: 4 },
  },
  {
    id: 'aria-sensor',
    title: 'ARIA Sensor',
    kind: 'module',
    outputId: 'aria-sensor',
    requires: { ariaChips: 4, circuitMesh: 4 },
  },
  {
    id: 'vector-drill-chip',
    title: 'Vector Drill Chip',
    kind: 'module',
    outputId: 'vector-drill-chip',
    requires: { circuitMesh: 8, nullFragments: 1 },
  },
];
