...
export const placeholderDApps: DApp[] = [
  ...
  },
  {
    ...
    category: 'general',
    utility: 'Staged L1 payouts for freelancers, builders, and game milestones with timed releases.',
    process: 'Fund a deal, split into 2-5 milestones with unlock dates. Beneficiary claims each slice when due.',
    benefits: 'Programmable payment schedules without trusting a middleman to release funds.',
    developer: 'Kasparex',
    developerLinks: [
      { label: 'Covenant Lab', url: 'https://www.kasparex.com/dapps/covenant-lab' },
      { label: 'Silverscript', url: 'https://github.com/kaspanet/silverscript' },
    ...
    provider: 'Kasparex',
    version: '0.1.0',
    description: 'Milestone escrow prototype: covenant-enforced staged KAS releases on a schedule.',
    createdAt: new Date().toISOString(),
  },
  {
    ...
    category: 'general',
    utility: 'Assurance-contract crowdfunds: goal + deadline with creator claim or backer refunds.',
    process: 'Launch a campaign, accept pledges until deadline. Creator claims if goal met; otherwise backers refund.',
    benefits: 'Transparent L1 pooling for launches, drops, and community raises.',
    developer: 'Kasparex',
    developerLinks: [
    ...
    provider: 'Kasparex',
    version: '0.1.0',
    description: 'Crowdfund prototype with covenant-style goal enforcement and refund paths.',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'covenant-voucher',
    ...
    category: 'general',
    utility: 'Hashlock gift cards: lock KAS, share a secret, redeem before expiry.',
    process: 'Mint a voucher with amount and expiry. Share the secret off-chain. Holder redeems with preimage proof.',
    benefits: 'Private transfers, tips, and promo credits with L1-enforced expiry and single-use rules.',
    developer: 'Kasparex',
    developerLinks: [
      { label: 'Covenant Lab', url: 'https://www.kasparex.com/dapps/covenant-lab' },
      { label: 'Telegram', url: 'https://t.me/kasparex' },
    ...
    provider: 'Kasparex',
    version: '0.1.0',
    description: 'Hashlock voucher prototype (SHA-256 preimage claim), mapping to HTLC-style covenant scripts.',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'revenue-tree',
