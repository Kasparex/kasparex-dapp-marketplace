...
export const placeholderDApps: DApp[] = [
  ...
  },
  {
    ...
    process: 'Connect wallet, compose your message with rich formatting, review payload chunks and fees, then publish to the Genesis archive.',
    ...
    provider: 'Kasparex',
    version: '0.2.0',
    description: 'Genesis is the Kasparex message board on Kaspa L1. Compose rich-text notes with payload-based pricing, browse the archive, and earn Hub Points when you publish.',
    security: 'Covenant-ready canonical JSON payloads split into L1 chunks. Simulator runtime today; production covenant deploy when wallets support native transactions.',
    roadmap: 'Done: Rich editor, payload pricing, Messages tab\nNext: Covenant deploy on mainnet\nFuture: Public indexer for Genesis archive',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'lockbox',
