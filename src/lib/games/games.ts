...
export const placeholderGames: Game[] = [
  ...
  },
  {
    ...
    slug: 'cipher-vaults',
    description: 'Open timed Cipher Vault covenants on the Kaspa network. Solve rune grids, bank Cipher Fragments, and refine them into Hub redeem points. Entry from 10 KAS.',
    instructions:
      'Connect your Kaspa wallet. Pay entry from the Calculation breakdown, solve the Cipher Grid within the move limit and timer, bank Cipher Fragments, then refine them from the Game Deck into Hub points.',
    gameType: 'puzzle',
    difficulty: 'medium',
    entryCostKAS: 10,
    status: 'beta',
