      ...
      <main className={`flex min-h-[calc(100vh-4rem)] flex-1 flex-col lg:flex-row ${HUB_PAGE_BG}`}>
        ...
        <div className={HUB_MAIN_COLUMN}>
          <div className={HUB_MAIN_INNER}>
            ...
            <div className={`relative mb-10 overflow-hidden rounded-3xl border border-zinc-200 bg-gradient-to-br from-zinc-100 via-cyan-50/50 to-lime-50/40 px-6 py-12 sm:px-8 dark:border-zinc-800/50 dark:from-zinc-950 dark:via-cyan-950/25 dark:to-zinc-950 ${HUB_HALO_DESKTOP_ONLY}`}>
              <div className="absolute inset-0 overflow-hidden">
                <div className="absolute right-0 top-0 h-[80%] w-[60%] rounded-full bg-[radial-gradient(ellipse_at_top_right,_rgba(6,182,212,0.14),transparent_70%)] blur-3xl dark:bg-[radial-gradient(ellipse_at_top_right,_rgba(6,182,212,0.18),transparent_70%)]" />
                <div className="absolute bottom-0 left-0 h-[60%] w-[50%] rounded-full bg-[radial-gradient(ellipse_at_bottom_left,_rgba(132,204,22,0.12),transparent_70%)] blur-3xl dark:bg-[radial-gradient(ellipse_at_bottom_left,_rgba(132,204,22,0.14),transparent_70%)]" />
              ...
              <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                <div className="max-w-2xl">
                  <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[color:var(--hub-accent-border)] bg-[color:var(--hub-accent-muted)] px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-cyan-900 dark:text-[color:var(--hub-accent-light)]">
                  ...
                  <h1 className="mb-4 text-4xl font-black leading-tight text-zinc-900 dark:text-white sm:text-5xl md:text-6xl">
                    Kasparex{' '}
                    <span className="bg-gradient-to-r from-cyan-600 via-teal-500 to-lime-500 bg-clip-text text-transparent dark:from-cyan-300 dark:via-teal-300 dark:to-lime-300">
                      Protocols
                    </span>
                  </h1>
                ...
                <div className="relative hidden w-[280px] shrink-0 items-center justify-center lg:flex">
                  <div className="pointer-events-none relative opacity-90">
                    ...
                    <div className="absolute -bottom-2 -right-2 h-48 w-40 -rotate-6 transform rounded-xl border-2 border-lime-400/30 bg-zinc-100/90 shadow-xl dark:bg-zinc-800/90" />
