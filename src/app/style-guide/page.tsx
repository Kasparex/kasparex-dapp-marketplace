...
export default function StyleGuidePage() {
  ...
  const styleElements: Record<string, any[]> = {
    ...
    alerts: [
      ...
      {
        id: 'warning-violet',
        name: 'Warning Alert (Violet)',
        description: 'Violet warning alert - using violet color palette for comments module',
        className: 'p-4 bg-violet-50 dark:bg-violet-950/50 rounded-lg',
        example: (
          <div className="p-4 bg-violet-50 dark:bg-violet-950/50 rounded-lg flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-violet-900 dark:text-violet-100 mb-1">Warning</h4>
              <p className="text-sm text-violet-700 dark:text-violet-300">Please review this information carefully.</p>
            </div>
          </div>
        ),
      },
