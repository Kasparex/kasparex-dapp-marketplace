    ...
    for (const g of games) {
      ...
      const rewards =
        g.rewardConfig?.gridReward || g.rewardConfig?.xpReward
          ? `${g.rewardConfig?.gridReward ? `${g.rewardConfig.gridReward} GRID` : ''}${g.rewardConfig?.gridReward && g.rewardConfig?.xpReward ? ' · ' : ''}${g.rewardConfig?.xpReward ? `${g.rewardConfig.xpReward} pts` : ''}`
          : 'Unified deck';
