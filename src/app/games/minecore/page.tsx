...
const LORE_STORY = `Beneath Kaspaland lies an ancient mining layer formed from condensed BlockDAG energy.

Krex built Kasparex on the Kaspa source above, but the diamond network below is older than the city itself. ARIA monitors stability as Vector designs modular rigs to reach deeper veins.

You are an operator. Craft parts, build mining plants, run extraction cycles, refine diamonds, and grow your facility.`;
