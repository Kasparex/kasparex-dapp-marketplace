      ...
      <section>
        ...
        <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
          <li className="flex gap-3">
            ...
            Connect your wallet and go to Studio → My Ads.
          </li>
          <li className="flex gap-3">
          ...
          <li className="flex gap-3">
            ...
            Upload your image, add a link and title, then pay in KAS.
          </li>
          <li className="flex gap-3">
            ...
            Your ad goes live immediately and automatically expires when the period ends.
          </li>
        </ul>
      </section>
