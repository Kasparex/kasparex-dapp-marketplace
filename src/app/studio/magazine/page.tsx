...
export default function StudioMagazinePage() {
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Premium Halo Header */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-100 via-blue-50/30 to-zinc-100 dark:from-zinc-950 dark:via-blue-950/30 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800 p-8 md:p-12">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                <span className="px-3 py-1 bg-blue-500/10 text-blue-700 dark:text-blue-400 text-xs font-bold rounded-full uppercase tracking-widest border border-blue-500/20">
                                    Magazine Studio
                                </span>
                            </div>
