    ...
    <KxListingCard accent={accent} className="relative flex flex-col min-h-0">
      <KxListingCardMedia>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full h-full bg-gradient-to-br from-white via-cyan-500/5 to-transparent dark:from-zinc-900 dark:via-cyan-500/10 dark:to-zinc-950" />
          <div className="absolute inset-0 flex items-center justify-center">
      ...
      <KxListingCardBody className="relative z-10 flex flex-1 min-h-0 flex-col">
        <div className="flex items-start justify-between gap-3 mb-2">
          <h3 className="flex-1 truncate text-[15px] font-semibold text-zinc-900 dark:text-zinc-100">
            {title}
          </h3>
        </div>
