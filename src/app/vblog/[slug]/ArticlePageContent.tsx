    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-950">
      ...
      <main className="flex-1 min-h-[calc(100vh-4rem)]">
        ...
        <div className="w-full max-w-5xl mx-auto font-sans">
          ...
          {isLinked && (
            <div className="mb-8 p-6 bg-gradient-to-r from-[#0884a4]/10 to-teal-500/10 border border-[#0884a4]/20 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#0884a4] rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
