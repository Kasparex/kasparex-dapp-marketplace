...
export function MagazineHeader() {
    return (
        <div className="relative mb-12 py-12 px-6 rounded-3xl overflow-hidden bg-gradient-to-br from-zinc-100 via-cyan-50/50 to-zinc-100 dark:bg-zinc-950 border border-zinc-200 dark:border-transparent">
            ...
            <div className="absolute right-0 bottom-0 top-0 w-1/3 hidden lg:flex items-center justify-center opacity-40">
                <div className="relative w-64 h-80 rounded-lg border-2 border-cyan-500/30 transform rotate-12 -translate-x-12 translate-y-12 shadow-2xl overflow-hidden bg-white dark:bg-transparent">
                ...
                <div className="relative w-64 h-80 rounded-lg border-2 border-emerald-500/30 transform -rotate-6 shadow-2xl overflow-hidden bg-zinc-200 dark:bg-zinc-800">
