  ...
  switch (type) {
    ...
    case 'foreman':
      return {
        title: 'Foreman slot',
        description:
          'Deploy as Foreman on Workers, then bind that deck row to a plant Crew slot on Mining. That unlocks AUTO on that plant (automation infra such as Regen Coil still applies).',
      };
    default:
