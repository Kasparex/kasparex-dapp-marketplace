            ...
            resources={[
              {
                ...
                hint: 'Your in-game Diamonds balance. Refinement points accumulate when you Refine. Click to open Mining.',
                accent: 'diamonds',
              ...
              },
              {
                ...
                hint: 'Your Kaspa L1 wallet balance (KasWare/Kastle). Used for Garage purchases. Click to open Shop.',
                accent: 'kas',
              ...
              },
              {
                ...
                hint: `Your KREX balance on L1. Tier ${krexTier} gives KAS-only Garage discounts. Click to open Shop.`,
                accent: 'krex',
                onClick: () => setTab('upgrades'),
              },
            ]}
