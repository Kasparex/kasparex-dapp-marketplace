    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900/60">
        <h3 className="mb-2 flex items-center gap-2 text-lg font-bold text-zinc-900 dark:text-zinc-100">
          Power budget
          <GameTooltip content="Each drill draws MW. If total draw exceeds your cap, mining efficiency scales down. Upgrade cap to remove brownouts.">
        ...
        <div className="flex flex-wrap gap-2">
          <GameTooltip content="Demo progression: adds another surface drill (increases draw and yield). Future: priced in KAS/KREX with receipt verification.">
          ...
          <GameTooltip content="Demo: +4 MW to your site cap. Paid upgrades will post a Kasplex L2 or L1 receipt when wired.">
