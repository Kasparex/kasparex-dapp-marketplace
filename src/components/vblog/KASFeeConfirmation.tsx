        ...
        <div className="px-6 py-4">
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#e30d1b]/10 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-[#e30d1b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
