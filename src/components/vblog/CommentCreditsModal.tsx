                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-700 px-4 py-3">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    {nftStatus.hasDiamondNFT && (
                      <span className="px-2.5 py-1 rounded-lg bg-[color:var(--hub-accent-muted)] text-teal-800 dark:text-cyan-300 text-xs font-semibold">
                        Diamond NFT - 20% off
                      </span>
                    )}
                    ...
                    return (
                      <button
                        ...
                        className={`p-4 rounded-2xl border transition-all text-left ${
                          isSelected
                            ? 'border-[color:var(--hub-accent)] bg-[color:var(--hub-accent-muted)] dark:bg-[color:var(--hub-accent-muted)]'
                      ...
                      >
                        ...
                        <div className="mt-2 text-sm font-bold text-[color:var(--hub-accent)] tabular-nums">
        ...
        <div className="px-6 py-4 border-t border-zinc-200 dark:border-zinc-800 flex flex-wrap items-center justify-between gap-3">
          ...
          {isWalletConnected && hasUnlimitedCredits && (
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-lg bg-[color:var(--hub-accent)] text-white font-medium text-sm"
            >
              Close
            </button>
          )}
