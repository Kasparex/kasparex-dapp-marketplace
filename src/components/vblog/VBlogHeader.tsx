    ...
    <div className="relative mb-12 py-12 px-6 rounded-3xl overflow-hidden bg-zinc-950">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight">
          Kasparex <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">vBlog</span>
        </h1>
      ...
      <div className="absolute right-0 bottom-0 top-0 w-1/3 hidden lg:flex items-center justify-center opacity-30">
        <div className="relative w-64 h-80 rounded-2xl border-2 border-orange-500/30 transform -rotate-12 -translate-x-12 translate-y-12 shadow-2xl overflow-hidden bg-zinc-900 flex items-center justify-center p-8">
        ...
        <div className="relative w-64 h-80 rounded-2xl border-2 border-amber-500/30 transform rotate-6 shadow-2xl overflow-hidden bg-zinc-800 flex flex-col p-6">
