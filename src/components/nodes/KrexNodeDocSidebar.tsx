      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-8">
          ...
          <nav className="space-y-1">
            {TOC_ITEMS.map((item) => (
              <button
                ...
                className={`k-sidebar-item w-full text-left group ${activeId === item.id ? 'k-sidebar-item-active' : ''}`}
              >
                <span className={`k-sidebar-icon transition-colors duration-200 ${activeId === item.id ? 'text-[#02abb8]' : 'text-zinc-500 dark:text-zinc-400 group-hover:text-[#02abb8]'}`}>
        ...
        <section>
          ...
          <nav className="space-y-1">
            ...
            >
              <span className="k-sidebar-icon text-zinc-500 dark:text-zinc-400 group-hover:text-[#02abb8] transition-colors">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            >
              ...
              <span className="text-[11px] font-bold uppercase tracking-wider truncate">Knowledge base</span>
            </Link>
            <a
