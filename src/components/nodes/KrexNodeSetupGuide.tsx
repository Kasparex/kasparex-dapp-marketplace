...
/**
 * Practical setup content for `/nodes` (Setup tab) — same surface style as the dashboard (no hero / iframe frame).
 */
export function KrexNodeSetupGuide() {
  return (
    <div className="space-y-6 max-w-4xl">
      <section id="what-is-krex-node" className={SECTION}>
      ...
      <section id="node-types-setup" className={SECTION}>
      ...
      <section id="how-to-run" className={SECTION}>
        ...
        <ol className="list-decimal pl-5 space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <li>
            <span className="font-semibold text-zinc-900 dark:text-zinc-100">Configure</span> — point <code className="text-xs bg-zinc-100 dark:bg-zinc-800 px-1 rounded">apiBaseUrl</code> at the
            production Worker URL and set <code className="text-xs bg-zinc-100 dark:bg-zinc-800 px-1 rounded">nodeId</code> /{' '}
