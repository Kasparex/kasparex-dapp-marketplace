...
export function DAppCard({ dapp }: DAppCardProps) {
  ...
  const tokenTicker = contractData?.ticker || generateSimulatedTicker(mergedDApp.name);
    ...
    >
      ...
      <div className="flex items-start gap-4 relative z-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Category/Version/ID Section */}
          <div className="flex items-center gap-2 flex-wrap mb-3 pt-3 border-t border-zinc-200/50 dark:border-zinc-800/50">
