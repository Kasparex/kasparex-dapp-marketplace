            ...
            <div className="space-y-8">
                <section>
                    ...
                    <nav className="space-y-1">
                        ...
                        />
                        <SidebarItem
                            href="/u?tab=workspace&view=portfolio"
                            label="My Portfolio"
                        ...
                        />
                        <SidebarItem
                            href="/u?tab=workspace&view=activity"
                ...
                <section>
                    ...
                    <nav className="space-y-1">
                        <SidebarItem
                            href="/u?tab=workspace&view=vblog"
                            label="vBlog Article"
                ...
                <section>
                    ...
                    <nav className="space-y-1">
                        ...
                        />
                        <SidebarItem
                            href="/u?tab=assets&view=history"
