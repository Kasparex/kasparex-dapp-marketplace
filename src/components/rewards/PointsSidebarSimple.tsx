    ...
    >
      ...
      <SidebarSection title="On this page">
        <nav className="space-y-0.5">
          <SidebarNavItem href="/points#points-intro" label="Overview" icon={sectionIcon} />
          <SidebarNavItem href="/points#module-scoring-rules" label="Module scoring rules" icon={sectionIcon} />
          <SidebarNavItem href="/points#nft-slot-points" label="NFT slot points" icon={sectionIcon} />
        </nav>
      </SidebarSection>
    </UnifiedSidebar>
  );
