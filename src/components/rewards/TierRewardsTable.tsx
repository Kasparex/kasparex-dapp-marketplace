...
export function TierRewardsTable({ currentTier, krexBalance }: TierRewardsTableProps) {
  ...
  const benefitRows = [
    ...
    { 
      ...
      tooltip: 'Get early access to new dApps, features, and beta testing opportunities before they are available to the general public.',
    },
    { 
      id: 'benefit2', 
      ...
      tooltip: 'Access to advanced analytics dashboard with detailed insights into your rewards, transactions, and ecosystem participation.',
    },
  ];
