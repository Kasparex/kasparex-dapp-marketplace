...
export function PointsHeader() {
  return (
    <div className="relative mb-10 py-12 px-6 sm:px-8 rounded-3xl overflow-hidden bg-gradient-to-br from-zinc-100 via-sky-50/60 to-zinc-100 dark:from-zinc-950 dark:via-sky-950/30 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800/50">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-[60%] h-[80%] bg-[radial-gradient(ellipse_at_top_right,_rgba(14,165,233,0.12),transparent_70%)] dark:bg-[radial-gradient(ellipse_at_top_right,_rgba(14,165,233,0.16),transparent_70%)] rounded-full blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/25 text-sky-700 dark:text-sky-300 text-[10px] font-black uppercase tracking-[0.2em] mb-6">
            Points
          </div>
        ...
        <div className="hidden lg:flex items-center justify-center flex-shrink-0 opacity-90">
          <div className="relative">
            <div className="w-48 h-56 rounded-2xl border-2 border-sky-500/30 bg-white/80 dark:bg-zinc-900/80 shadow-2xl shadow-sky-500/10 rotate-3 transform" />
