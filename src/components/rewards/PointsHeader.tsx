...
export function PointsHeader() {
  return (
    <div className="relative mb-10 py-12 px-6 sm:px-8 rounded-3xl overflow-hidden bg-gradient-to-br from-zinc-100 via-amber-50/50 to-zinc-100 dark:from-zinc-950 dark:via-amber-950/30 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800/50">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-zinc-900 dark:text-white mb-4 leading-tight">
            Kasparex <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-cyan-600 to-amber-600 dark:from-amber-400 dark:via-[#02abb8] dark:to-amber-400">Points</span>
          </h1>
        ...
        <div className="hidden lg:flex items-center justify-center flex-shrink-0 opacity-90">
          <div className="relative">
            <div className="w-48 h-56 rounded-2xl border-2 border-amber-500/30 bg-white/80 dark:bg-zinc-900/80 shadow-2xl shadow-amber-500/10 rotate-3 transform" />
