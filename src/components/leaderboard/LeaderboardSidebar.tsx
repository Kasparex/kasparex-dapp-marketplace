      ...
      <SidebarSection title="Navigation">
        <nav className="space-y-0.5">
          ...
          <SidebarNavItem
            ...
            label="Vault & unlocks"
            active={pathname.startsWith('/chronicles/dashboard')}
            icon={<svg className="w-4 h-4 k-sidebar-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-3.314 0-6 1.343-6 3v6c0 1.657 2.686 3 6 3s6-1.343 6-3v-6c0-1.657-2.686-3-6-3z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 11c0 1.657 2.686 3 6 3s6-1.343 6-3" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8V6a3 3 0 116 0v2" /></svg>}
          />
        </nav>
      </SidebarSection>
    </UnifiedSidebar>
