    ...
    >
      ...
      <SidebarSection title="Navigation">
        <nav className="space-y-0.5">
          <SidebarNavItem href="/leaderboard" label="Leaderboard" active={pathname.startsWith('/leaderboard')} />
          <SidebarNavItem href="/points" label="Points rules" active={false} />
          <SidebarNavItem href="/chronicles/dashboard" label="Vault & unlocks" active={pathname.startsWith('/chronicles/dashboard')} />
        </nav>
      </SidebarSection>
    </UnifiedSidebar>
  );
