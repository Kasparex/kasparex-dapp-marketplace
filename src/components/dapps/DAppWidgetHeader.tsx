  ...
  return (
    <>
      <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 relative">
        ...
        <div className="flex items-start gap-4 mb-4 relative">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              {/* Developer Dropdown next to title */}
              {deployerAddress && (
        ...
        {/* Actions Bar: Network/Compatibility/Debug (left) + Icons (right) */}
        <div className="flex flex-wrap items-center justify-between gap-3 mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
          {/* Left: Network, Compatibility, Debug */}
          ...
          {/* Right: Icon Buttons (Info, Embed, Star, Heart) */}
          {!hideIcons && (
