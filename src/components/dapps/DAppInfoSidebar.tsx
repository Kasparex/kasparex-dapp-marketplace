        ...
        <div className={`p-4 lg:p-6 ${isHidden ? 'hidden' : ''}`}>
          ...
          <div className="space-y-6">
            {deployerAddress && (
              <Link
                href={deployerUrl}
                className="k-sidebar-item w-full !px-3"
                aria-label="View developer profile"
              >
                <Avatar address={deployerAddress} size={24} className="flex-shrink-0" />
                <span className="text-zinc-900 dark:text-zinc-100 flex-1 text-left truncate font-bold">
