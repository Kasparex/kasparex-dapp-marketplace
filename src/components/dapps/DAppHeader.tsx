...
export function DAppHeader({ dapp, contractAddress }: DAppHeaderProps) {
  ...
  const { profile: deployerProfile, emoji: deployerEmoji } = useDeployerProfile(
    ...
    <>
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 sm:p-6 mb-6">
        <div className="flex items-start justify-between gap-4 mb-4">
          {/* Left side: Title, Category, Version, Deployer */}
          <div className="flex-1 min-w-0">
            ...
            {deployerAddress && (
              <div className="flex items-center gap-2 mt-2">
                <div className="w-6 h-6 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-xs">
                  {deployerEmoji}
                </div>
                <a
                  href={deployerUrl}
