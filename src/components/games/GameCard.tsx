  ...
  return (
    ...
    >
      <KxListingCardMedia className="border-b border-zinc-200/50 bg-gradient-to-br from-zinc-100 to-zinc-200 dark:border-zinc-800/50 dark:from-zinc-800 dark:to-zinc-900">
        ...
        {game.status === 'beta' && (
          <span className="absolute left-3 top-3 z-20 inline-flex items-center gap-1.5 rounded-md border border-purple-300 bg-purple-100 px-2.5 py-1 text-xs font-semibold text-purple-800 shadow-sm backdrop-blur-sm dark:border-purple-700 dark:bg-purple-900/30 dark:text-purple-300">
            Beta
          </span>
        )}
        ...
        <div className="mt-auto space-y-3">
          <div className="flex flex-wrap items-center justify-between gap-2 border-t border-zinc-200/50 pt-3 dark:border-zinc-800/50">
            <button
              ...
              className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-1.5 text-sm font-medium text-zinc-700 transition-colors hover:border-emerald-500/30 hover:bg-emerald-500/5 hover:text-emerald-800 dark:border-zinc-800 dark:bg-zinc-800/50 dark:text-zinc-300 dark:hover:text-emerald-300"
            ...
            <div className="flex items-center gap-1">
              ...
              >
                <svg className="h-4 w-4" fill={isFavoriteGame ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button
                ...
                className={`relative rounded-lg p-1.5 transition-colors ${
                  isLiked
                    ? 'bg-red-50 text-red-500 hover:text-red-600 dark:bg-red-900/20'
              ...
              >
                ...
                {likeCount > 0 && (
                  <span className="absolute -right-1 -top-1 text-xs font-medium text-zinc-600 dark:text-zinc-400">
                    {likeCount}
                  </span>
                )}
              </button>
