...
import { AiSourceSwitcher, type AiSourceFilter } from '@/components/ai/AiSourceSwitcher';
import { HUB_HALO_DESKTOP_ONLY, HUB_HALO_MOBILE_FALLBACK } from '@/lib/hub/haloHeaders';

export function AiHeader() {
  const [sourceFilter, setSourceFilter] = useState<AiSourceFilter>('all');

  return (
    <>
      <div className={`mb-6 ${HUB_HALO_MOBILE_FALLBACK}`}>
        <AiSourceSwitcher value={sourceFilter} onChange={setSourceFilter} />
      </div>
      <div
