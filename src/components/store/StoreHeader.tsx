        ...
        <div className="relative mb-12 py-12 px-6 rounded-3xl overflow-hidden bg-zinc-950">
            ...
            <div className="relative z-10 w-full">
                ...
                <h1 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight">
                    Kasparex <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-indigo-400">Store</span>
                </h1>
            ...
            <div className="absolute right-0 bottom-0 top-0 w-1/3 hidden lg:flex items-center justify-center opacity-40">
                <div className="relative w-64 h-80 rounded-lg border-2 border-violet-500/30 transform rotate-12 -translate-x-12 translate-y-12 shadow-2xl overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-zinc-800 to-zinc-900" />
                    <div className="absolute top-1/4 left-1/4 right-1/4 bottom-1/4 border border-zinc-700 rounded" />
                </div>
                <div className="relative w-64 h-80 rounded-lg border-2 border-indigo-500/30 transform -rotate-6 shadow-2xl overflow-hidden bg-zinc-800">
