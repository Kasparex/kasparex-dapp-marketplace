    ...
    return (
      <section id="markets" className="space-y-6">
        <GameOverviewTitleBlock
          kicker="Markets"
          title="Venues"
          subtitle="Where this token is listed to trade."
          as="h3"
          compact
        />
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {markets.map((market, index) => (
          <a
            ...
            className="kx-metadata-stat-card flex flex-col gap-3 rounded-2xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900/80"
          >
