...
export const KASPPAREX_TOOLTIP_SURFACE_CLASS =
  'z-[100000] !h-auto !max-h-[min(70vh,20rem)] w-max max-w-sm overflow-auto rounded-lg border border-zinc-300 bg-zinc-100 px-3 py-2.5 text-sm leading-snug text-zinc-800 shadow-xl dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100';
