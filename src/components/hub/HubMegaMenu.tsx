  ...
  const panel = open ? (
    <>
      ...
      >
        ...
        <div className={isMobile ? 'max-h-[min(calc(100dvh-6rem),520px)] overflow-y-auto overscroll-contain p-2' : 'max-h-[min(calc(100dvh-6rem),480px)] overflow-y-auto overscroll-contain'}>
          {isMobile ? (
