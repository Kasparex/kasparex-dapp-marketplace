...
const NAV_ITEMS = [
  { href: '/chronicles', label: 'Overview', icon: homeIcon, match: (p: string) => p === '/chronicles' },
  { href: '/chronicles/chapters', label: 'Chapters', icon: bookIcon, match: (p: string) => p.startsWith('/chronicles/chapters') },
