# Anonymous Feedback Box Integration Guide

Step-by-step guide for integrating Anonymous Feedback Box into your application.
...
```typescript
import { ANONYMOUS_FEEDBACK_BOX_ABI } from '@/lib/contracts/abis';
```
...
function MyComponent() {
  const { data, isLoading } = useReadContract({
    ...
    abi: ANONYMOUS_FEEDBACK_BOX_ABI,
...
export function useAnonymousFeedbackBox() {
  // Read operations
...
Anonymous Feedback Box supports the following networks:
...
- [Contract Reference](./contracts/anonymous-feedback-box.md)
- [dApp Overview](./dapps/anonymous-feedback-box.md)
