# Multi-Choice Voting Panel Integration Guide

Step-by-step guide for integrating Multi-Choice Voting Panel into your application.
...
```typescript
import { MULTI-CHOICE_VOTING_PANEL_ABI } from '@/lib/contracts/abis';
```
...
function MyComponent() {
  const { data, isLoading } = useReadContract({
    ...
    abi: MULTI-CHOICE_VOTING_PANEL_ABI,
...
export function useMulti-ChoiceVotingPanel() {
  // Read operations
...
Multi-Choice Voting Panel supports the following networks:
...
- [Contract Reference](./contracts/multi-choice-voting-panel.md)
- [dApp Overview](./dapps/multi-choice-voting-panel.md)
