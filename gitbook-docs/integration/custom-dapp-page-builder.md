# Custom dApp Page Builder Integration Guide

Step-by-step guide for integrating Custom dApp Page Builder into your application.
...
```typescript
import { CUSTOM_DAPP_PAGE_BUILDER_ABI } from '@/lib/contracts/abis';
```
...
function MyComponent() {
  const { data, isLoading } = useReadContract({
    ...
    abi: CUSTOM_DAPP_PAGE_BUILDER_ABI,
...
export function useCustomdAppPageBuilder() {
  // Read operations
...
Custom dApp Page Builder supports the following networks:
...
- [Contract Reference](./contracts/custom-dapp-page-builder.md)
- [dApp Overview](./dapps/custom-dapp-page-builder.md)
