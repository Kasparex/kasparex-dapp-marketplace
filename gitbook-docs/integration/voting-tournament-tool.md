# Voting Tournament Tool Integration Guide

Step-by-step guide for integrating Voting Tournament Tool into your application.
...
```typescript
import { VOTING_TOURNAMENT_TOOL_ABI } from '@/lib/contracts/abis';
```
...
function MyComponent() {
  const { data, isLoading } = useReadContract({
    ...
    abi: VOTING_TOURNAMENT_TOOL_ABI,
...
export function useVotingTournamentTool() {
  // Read operations
...
Voting Tournament Tool supports the following networks:
...
- [Contract Reference](./contracts/voting-tournament-tool.md)
- [dApp Overview](./dapps/voting-tournament-tool.md)
