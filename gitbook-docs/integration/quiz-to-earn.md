# Quiz-to-Earn Integration Guide
...
```typescript
import { QUIZ-TO-EARN_ABI } from '@/lib/contracts/abis';
```
...
export function useQuiz-to-Earn() {
  // Read operations
...
- [Contract Reference](./contracts/quiz-to-earn.md)
- [dApp Overview](./dapps/quiz-to-earn.md)
