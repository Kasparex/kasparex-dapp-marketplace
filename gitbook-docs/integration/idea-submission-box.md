# Idea Submission Box Integration Guide

Step-by-step guide for integrating Idea Submission Box into your application.
...
```typescript
import { IDEA_SUBMISSION_BOX_ABI } from '@/lib/contracts/abis';
```
...
export function useIdeaSubmissionBox() {
  // Read operations
...
Idea Submission Box supports the following networks:
...
- [Contract Reference](./contracts/idea-submission-box.md)
- [dApp Overview](./dapps/idea-submission-box.md)
