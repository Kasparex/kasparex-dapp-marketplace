...
class PinataService {
  ...
  constructor(config?: PinataConfig) {
    this.apiKey = config?.apiKey || (typeof window !== 'undefined' ? (window as any).ENV?.PINATA_API_KEY : process.env.PINATA_API_KEY) || '';
    this.apiSecret = config?.apiSecret || (typeof window !== 'undefined' ? (window as any).ENV?.PINATA_API_SECRET : process.env.PINATA_API_SECRET) || '';
  }
