...
function rotateLevelsForActivation(tree: RevenueTreeData, userWalletAddress: string): RevenueTreeData {
  // Sort existing levels ascending (1 Ôćĺ 5)
  ...
  // Levels 2ÔÇô5: shift existing wallets up by one level (drop old level 5)
...
function simulateQuickStats(tree: RevenueTreeData): QuickStats {
  ...
  const referrals = baseReferrals + Math.floor(Math.random() * 6); // +0ÔÇô5
  const averageKasPerReferral = 100 * (0.5 + Math.random()); // 50ÔÇô150 KAS
  ...
  // Assume 6ÔÇô12 full revenue cycles per year
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 space-y-4">
                ...
                <div className="pt-2 border-t border-zinc-100 dark:border-zinc-800 space-y-2">
                  ...
                  <input
                    ...
                    placeholder="0x... (optional ÔÇô simulate different referral links)"
